...
const integrationOptions = [
    {
        icon: Link2,
        title: "CRM Connected",
        description: "Connect your existing CRM to unlock the full potential of AI-RD1. Sync contacts, automate workflows, and leverage your customer data for personalized conversations.",
        features: [
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-lg sm:text-xl text-body max-w-2xl mx-auto mb-8">
                                AI-RD1 acts as your AI Voice Operator, handling calls with intelligence,
