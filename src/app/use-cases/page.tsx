                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-lg sm:text-xl text-body max-w-2xl mx-auto mb-8">
                                Discover how AI-RD1 transforms communication across sectors—from healthcare
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="max-w-3xl mx-auto text-center mb-12 lg:mb-16">
                            ...
                            <p className="text-lg text-body">
                                See how AI-RD1 adapts to your specific business needs and use cases.
                            </p>
                        </div>
                    ...
                    <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <p className="text-lg text-body max-w-2xl mx-auto mb-8">
                                AI-RD1 is highly customizable. Contact us to discuss how we can tailor
